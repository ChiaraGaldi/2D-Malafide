...
def main(args):
    ...
    CADDM_malafide_model_load_path = os.path.join(args.malafilter_path, args.attack, str(args.malafide_filter_size), 'weights', 'best_filter.pth') 
    ...
    with open('SBI_test_results_caddm.txt', 'a') as tres:
